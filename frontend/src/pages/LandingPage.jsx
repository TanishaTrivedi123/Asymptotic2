...
const LandingPage = () => {
  ...
  return (
    <div className="relative min-h-screen text-textColor flex items-center px-6 md:px-12 overflow-hidden">
      ...
      >
        <source src="/26798-359604169.mp4" type="video/mp4" />
      </video>
      ...
      <div className="w-full max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col justify-center items-start text-center md:text-left space-y-5">
          ...
          <h2 className="text-lg md:text-2xl font-inter font-semibold text-gray-300">
            Think Like an Interviewer <span className="text-redColor">•</span> Code Independently <span className="text-redColor">•</span> Validate Your Approach
          </h2>

          <p className="text-gray-400 font-roboto max-w-lg">
            Sharpen your problem-solving skills with carefully curated DSA patterns inspired by real interviews. 
            Write complete solutions independently, test your thinking, and validate your approach with precision. 
            Get instant clarity on doubts using AI assistance—so you stay focused and interview-ready.
          </p>
