...
const SideBar = ({chatTitles, loading, onSelectChat, onNewChat, currentChatId, open, setOpen}) => {
  ...
  return (
  <div className={`bg-black border-r border-white/10 flex flex-col z-20 ${open ? "w-64" : "w-16"}`}>
    ...
    <div className="p-3 flex items-center justify-between">
      ...
      <button onClick={handleOpen} className="p-2 hover:bg-white/5 rounded-lg transition">
        {open ? (
