    ...
    <nav className="bg-blackBg w-full text-textColor p-4 px-8 flex justify-between items-center fixed top-0 z-50 shadow-skyBlue shadow-[0_0_10px_rgba(56,189,248,0.25)]">
      ...
      <div>
        <ul className="hidden md:flex gap-12">
          <li className="font-medium text-lg font-inter hover:text-skyBlue">
          ...
          <li className="font-medium text-lg font-inter hover:text-skyBlue">
            <Link to="/ide">Solve Problems</Link>
          </li>
        </ul>
      </div>
      ...
      {isOpen && (
        <div className="fixed z-10 md:hidden bg-black inset-0 p-4">
          ...
          <div className="mt-6">
            <Link
              className="font-medium text-lg font-inter m-3 p-3 hover:bg-skyBlue block rounded-lg"
              to="/home"
            >
              Home
            </Link>
